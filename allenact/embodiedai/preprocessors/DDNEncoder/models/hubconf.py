...
def _make_dinov2_model(
    ...
    **kwargs,
    ...
    import allenact.embodiedai.preprocessors.DDNEncoder.models.vision_transformer as vits
    ...
    if pretrained:
        ...
        # load dinov2 locally
        dinov2_state_dict = torch.load(f"BraiNav/allenact/embodiedai/preprocessors/DDNEncoder/checkpoints/{model_name}_pretrain.pth") # dinov2 pretrain_model
        model.load_state_dict(dinov2_state_dict) # vits_length=175
