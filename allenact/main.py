...
def get_args():
    ...
    debug_mode = "train" # train or test
    ...
    if(debug_flag):
        parser.add_argument(
            ...
            "--experiment", 
            type=str, 
            default="pointnav_robothor_vanilla_rgb_resnet_ddppo",
            required=False,
        ...
        parser.add_argument( # train
            ...
            "--extra_tag",
            type=str,
            default="rnav_pointnav_vanilla_rgb_resnet_ddppo_clean",
            required=False,
        ...
        #     "--extra_tag",
        #     type=str,
        #     default="rnav_pointnav_vanilla_rgb_resnet_ddppo_Defocus_Blur_s5",
        #     required=False,
        #     help="Add an extra tag to the experiment when trying out new ideas (will be used"
        #     "as a subdirectory of the tensorboard path so you will be able to"
        #     "search tensorboard logs using this extra tag).",
        ...
        parser.add_argument(# train
            ...
            "--experiment_base",
            required=False,
            default="projects/robustnav_baselines/experiments/robustnav_train",
            type=str,
        ...
        #     "--experiment_base",
        #     required=False,
        #     default="projects/robustnav_baselines/experiments/robustnav_eval",
        #     type=str,
        #     help="experiment configuration base folder (default: working directory)",
        # )    
    else:
    ...
    if(debug_flag and debug_mode == 'test'):
        parser.add_argument( # # debug test
            "-o",
            "--output_dir",
            required=False,
            type=str,
            default="storage/robothor-pointnav-rgb-resnetgru-ddppo-eval",
        ...
        parser.add_argument( # debug
            ...
            "--checkpoint",
            required=False,
            default="YOUR_PATH/storage/checkpoints/xxx.pt",
            type=str,
        ...
        parser.add_argument( 
            ...
            required=False,
            type=str,
            default="storage/robothor-pointnav-rgb-resnetgru-ddppo",
            help="experiment output folder",
        )
        parser.add_argument( 
            "-c",
    ...
    parser.add_argument(
        "-s", "--seed", required=False, default="12345", type=int, help="random seed",
    )
    ...
    if(debug_flag and debug_mode == 'test'):
        parser.set_defaults(deterministic_agents=True)
