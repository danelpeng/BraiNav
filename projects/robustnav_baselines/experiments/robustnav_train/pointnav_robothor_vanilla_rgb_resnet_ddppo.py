"""
Experiment config to train a PointNav RGB policy
"""
...
class PointNavS2SRGBResNetDDPPO(ExperimentConfig, ABC):
    ...
    def machine_params(self, mode="train", **kwargs):
        ...
        if mode == "train":
            ...
            nprocesses = 0 if torch.cuda.is_available() else 0
    ...
    def _get_sampler_args_for_scene_split(
        ...
        return {
            ...
            "env_args": {
                **self.ENV_ARGS,
                "x_display": (
                    f"1.{devices[process_ind % len(devices)]}"
